...
/** Pending coordinator transfer claim window (assignee must accept in-meeting). */
export const COORDINATOR_TRANSFER_TTL_MS = 2 * 60 * 1000;

/** LiveKit data-channel topic for coordinator claim handoff. */
