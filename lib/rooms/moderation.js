...
export async function removeRoomParticipant({
  ...
  try {
    ...
    if (typeof repository.revokeParticipantRejoinGrantByParticipantIdentity === 'function') {

      await repository.revokeParticipantRejoinGrantByParticipantIdentity(room.id, identity, {
    ...
    // best-effort; LiveKit removal already succeeded
...
export async function endRoom({
  ...
  try {
    ...
    if (typeof repository.revokeParticipantRejoinGrantsForRoom === 'function') {

      await repository.revokeParticipantRejoinGrantsForRoom(room.id, {
